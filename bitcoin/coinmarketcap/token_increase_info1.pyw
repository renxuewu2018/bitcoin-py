...
# @Last Modified time: 2018-03-21 23:56:54
...
def run_total_job():
	...
	usd,cny = get_price()
	save_data((token_holders,transfers,watch_num,star_num,fork_num,commits_num,supply_num,token_id,get_time(),usd,cny))
	# 需要科学上网
	# telegram_spider()
	# twitter_spider()
	# facebook_spider()
...
cursor = con.cursor()
insert_sql = 'insert into token_increase_info(token_holders,transfers,github_watch,\
				github_star,github_fork,github_commits,supply,token_id,createtime,usd,cny) \
